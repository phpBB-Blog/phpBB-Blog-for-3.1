...
$schema_path = dirname(__FILE__) . '/../../docs/schemas/';
...
$supported_dbms = array('mysql_40', 'mysql_41', 'postgres', 'sqlite');
...
function get_schema_struct()
{
	...
	$schema_data['phpbb_blog_categories'] = array(
		'COLUMNS'		=> array(
			'id'					=> array('UINT', NULL, 'auto_increment'),
			'title'					=> array('VCHAR', ''),
			'description'			=> array('MTEXT_UNI', ''),
			'description_options'	=> array('UINT:11', 0),
			'description_bitfield'	=> array('VCHAR:255', ''),
			'description_uid'		=> array('VCHAR:8', ''),
	...
	$schema_data['phpbb_blog_post_comments'] = array(
		'COLUMNS'		=> array(
			'id'				=> array('UINT', NULL, 'auto_increment'),
			'post_id'			=> array('UINT:11', 0),
			'commenter_id'		=> array('UINT:11', 0),
			'comment'			=> array('MTEXT_UNI', ''),
			'comment_options'	=> array('UINT:11', 0),
	...
	$schema_data['phpbb_blog_posts'] = array(
		'COLUMNS'		=> array(
			'id'					=> array('UINT', NULL, 'auto_increment'),
			'category'				=> array('UINT:11', 0),
			'title'					=> array('VCHAR:255', ''),
			'poster_id'				=> array('UINT:11', 0),
			'post'					=> array('MTEXT_UNI', ''),
			'post_options'			=> array('UINT:11', 0),
			'post_bitfield'			=> array('VCHAR:255', ''),
			'post_uid'				=> array('VCHAR:8', ''),
			'ptime'					=> array('UINT:11', 0),
			'post_read_count'		=> array('UINT', 0),
			'post_last_edit_time'	=> array('UINT', 0),
			'post_edit_count'		=> array('UINT', 0),
		...
		'KEYS'			=> array(
			...
			'ptime'		=> array('INDEX', 'ptime'),
		),
	);

	$schema_data['phpbb_blog_tags'] = array(
		'COLUMNS'		=> array(
			'id'		=> array('UINT', NULL, 'auto_increment'),
			'tag'		=> array('VCHAR:255', ''),
