...
CREATE TABLE phpbb_blog_categories (
	...
	description_options INT4 DEFAULT '0' NOT NULL CHECK (description_options >= 0),
...
CREATE TABLE phpbb_blog_posts (
	...
	post_options INT4 DEFAULT '0' NOT NULL CHECK (post_options >= 0),
	post_bitfield varchar(255) DEFAULT '' NOT NULL,
	post_uid varchar(8) DEFAULT '' NOT NULL,
	ptime INT4 DEFAULT '0' NOT NULL CHECK (ptime >= 0),
	post_read_count INT4 DEFAULT '0' NOT NULL CHECK (post_read_count >= 0),
